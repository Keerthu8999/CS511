...
pub fn query(
    ...
    .appender(MapAppender::new(Box::new(|df: &DataFrame| {
        ...
        //         (
        //             (b.equal("Brand#12").unwrap() & c.gt_eq("1").unwrap() & c.lt_eq("11").unwrap() & d.gt_eq("1").unwrap() & d.lt_eq("5").unwrap()) || 
        //             (b.equal("Brand#23").unwrap() & c.gt_eq("10").unwrap() & c.lt_eq("20").unwrap() & d.gt_eq("1").unwrap() & d.lt_eq("10").unwrap()) || 
        //             (b.equal("Brand#34").unwrap() & c.gt_eq("20").unwrap() & c.lt_eq("30").unwrap() & d.gt_eq("1").unwrap() & d.lt_eq("15").unwrap())
        //         );
        ...
        // let mask2 = (b.equal("Brand#12").unwrap() & c.gt_eq("1").unwrap() & c.lt_eq("11").unwrap() & d.gt_eq("1").unwrap() & d.lt_eq("5").unwrap()); 
        // let mask3 = (b.equal("Brand#23").unwrap() & c.gt_eq("10").unwrap() & c.lt_eq("20").unwrap() & d.gt_eq("1").unwrap() & d.lt_eq("10").unwrap());
        // let mask4 = (b.equal("Brand#34").unwrap() & c.gt_eq("20").unwrap() & c.lt_eq("30").unwrap() & d.gt_eq("1").unwrap() & d.lt_eq("15").unwrap());
    ...
    hash_join_node.subscribe_to_node(&part_csvreader_node, 0); // Left Node
    hash_join_node.subscribe_to_node(&lineitem_where_node, 1); // Right Node
